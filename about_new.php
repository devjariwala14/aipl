...
while ($row = mysqli_fetch_array($Resp)) { ?>
    <main id="main">
        ...
        <section class="page-section bg-dark bg-dark-alpha-70 light-content"
                    ...
                    <div class="item-carousel owl-carousel">
                        ...
                        <div class="features-item">
                            ...
                            <div class="features-descr">
                                Lorem ipsum dolor sit amet, consectetur adipiscing elit. Quisque congue rhoncus enim, in
                                pharetra lacus.
                            </div>
                        </div>
                        <!-- End Features Item -->
                        ...
                        <div class="features-item">
                            ...
                            <div class="features-descr">
                                Mauris a libero et diam sodales semper. Aenean elit leo, hendrerit nec dolor id, rutrum
                                finibus velit.
                            </div>
                        </div>
                        <!-- End Features Item -->
        ...
        <section class="page-section">
            <div class="container position-relative">
                ...
                <div class="position-relative">
                    <div class="decoration-21 d-none d-lg-block" data-rellax-y data-rellax-speed="0.7"

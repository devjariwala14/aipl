 ...
 if(isset($_REQUEST["btndelete"]))
{
  ...
  try
  {
    $stmt_del = $obj->con1->prepare("DELETE FROM `terms_and_conditions` WHERE id = ?");
...
function add_data() {
    eraseCookie("edit_id");
    eraseCookie("view_id");
    window.location = "add_terms_and_condition.php";
}
...
<div class="modal fade" id="deleteModal" tabindex="-1">
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form method="post" action="terms_and_condition.php">
            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <table class="table datatable">
                        ...
                        <tbody>
                            <?php
                            $stmt = $obj->con1->prepare("SELECT * FROM `terms_and_conditions` ORDER BY `id` DESC");
                            $stmt->execute();

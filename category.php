        ...
        <div class="row mb-n30">
            ...
            while ($row = $Resp->fetch_assoc()) {
                ...
                <div class="col-md-6 col-lg-4 d-flex align-items-stretch mb-30">
                    <div class="services-3-item text-center w-100">
                        <a href="javascript:void(0);" onclick="setProduct(<?php echo $row['id']; ?>)" style="text-decoration: none; color: inherit;">
                            <div class="wow fadeInUpShort animated" data-wow-offset="50"
                                style="visibility: visible; animation-name: fadeInUpShort;">

                                <!-- Changed to square and larger image -->
                                <div class="services-3-icon" style="width: 100%; height: 250px;">
                                    <img src="dashboard/images/product/<?php echo $row["image"]; ?>" alt="Product Icon" style="width: 100%; height: 100%; object-fit: cover; border-radius: 0;">
                                </div>
